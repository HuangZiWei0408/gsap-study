type NavLinkType = Record<'id' | 'title', string>
type CocktailType = Record<'name' | 'country' | 'detail' | 'price', string>
type MockTailType = Record<'name' | 'country' | 'detail' | 'price', string>
type ProfileType = Record<'imgPath', string>
...
const cocktailLists: CocktailType[] = [
  {
...
const mockTailLists: MockTailType[] = [
  {
    name: 'Tropical Bloom',
    country: 'US',
    detail: 'Battle',
...
const profileLists: ProfileType[] = [
  {
...
type OpeningHourType = Record<'day' | 'time', string>
const openingHours: OpeningHourType[] = [
